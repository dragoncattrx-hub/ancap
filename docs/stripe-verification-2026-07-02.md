...
- Date: 2026-07-02
- Operator: ANCAP CI
- Commit SHA: 5e13b3f91747cc87b7dc0c36e2230988409e1866
- Environment: repo automated testmode
...
- Notes: Automated webhook+ledger E2E verified via pytest; live Stripe dashboard closure still operator-open.
...
- Generated at (UTC): `2026-07-02T08:35:13Z`
- Source template: `docs/STRIPE_VERIFICATION_EVIDENCE_TEMPLATE.md`
- Output path: `docs/stripe-verification-2026-07-02.md`
- Latest alias path: `docs/stripe-verification-latest.md`
- Generator: `scripts/generate_stripe_verification_packet.py`
- Generator repo HEAD: `master` @ `5e13b3f91747cc87b7dc0c36e2230988409e1866` (dirty working tree)
