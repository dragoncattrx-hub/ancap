...
- Roadmap refresh: milestones 1–4 explicitly marked as delivered, with milestone 5 focused on ACP tokenomics and distribution.
- Tokenomics docs synced: fixed supply and allocation/utility destinations aligned with protocol constants.
