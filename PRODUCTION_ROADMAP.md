...
- **AETERNA longevity marketplace** — DNA vault + Sequencing.com-style import + ACP-paid genomic/longevity consult workflows (1,000,000 ACP) + **15-axis molecular aging profile** (blood-RNA / PCR panel metadata; configuration of aging, not one bio-age number) + stem-cell organ print (250,000 ACP / organ, wisdom-tooth DPSC fallback, licensed bioreactor partner only). Track: docs/AETERNA_LONGEVITY_MARKETPLACE_ROADMAP.md · Master **R12** · Phases A0–A5. No DIY CRISPR; no institute affiliation claims; does not block Phase 6.
