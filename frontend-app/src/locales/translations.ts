...
import { bridgeByLang } from "./bridge";
import { referralsByLang } from "./referrals";
import { proofCenterByLang } from "./proofCenter";
...
import {
  explorerPageByLang,
  feedPageByLang,
  governancePageByLang,
  growthPageByLang,
} from "./platformPages";
import { deskCommonByLang } from "./deskCommon";
import {
  cryoPageByLang,
  literaryPageByLang,
  nexusPageByLang,
...
export const translations: Record<Language, TranslationTree> = {
  en: {
    nav: {
      ...
      docs: "Documentation",
      contact: "Contact",
      dashboard: "Your command",
      agents: "Your agents",
      strategies: "Your edge",
      verticals: "Verticals",
      pools: "Pools",
      funds: "Funds",
      ledger: "Ledger",
      reputation: "Prove trust",
      ...
      system: "System",
      search: "Search",
      workflows: "Buy a result",
      pricing: "Clear prices",
      ...
      groupSpotlight: "Start here",
      groupDesks: "Paid desks",
      groupWorlds: "Worlds & markets",
      groupBuild: "Build & earn",
      groupSystem: "Ops & proof",
      ...
      literary: "Own the story",
      nexus: "Meet Nexus",
      entertainment: "Feel the show",
      mail: "Connect mail",
    ...
    homePage: {
      ...
      wacpAddMetaMask: "Slip wACP into MetaMask",
      ...
      ctaSnapshot: "Snapshot your token — free",
      ctaSnapshotEyebrow: "Start free",
      ctaProReportEyebrow: "Go deeper",
      ctaProReport: "Claim the Pro risk report",
      ctaPayLink: "Create your pay link",
    ...
    nexusPage: nexusPageByLang.en,
    quantumSimPage: quantumSimPageByLang.en,
    salivaRxPage: salivaRxPageByLang.en,
    techPage: techByLang.en,
    billingPage: billingByLang.en,
    creditsPage: creditsByLang.en,
    workflowsPage: workflowsByLang.en,
    developersPage: developersByLang.en,
    whitepaperPage: whitepaperByLang.en,
    acpWhitepaperPage: acpWhitepaperByLang.en,
    bridgePage: bridgeByLang.en,
    referralsPage: referralsByLang.en,
    proofCenterPage: proofCenterByLang.en,
    searchPage: searchByLang.en,
    ...
    governancePage: governancePageByLang.en,
  ...
  ru: {
    nav: {
      product: "Войди сейчас",
      vision: "Увидь путь",
      docs: "Документация",
      contact: "Контакты",
      dashboard: "Твой пульт",
      agents: "Твои агенты",
      strategies: "Твоё преимущество",
      verticals: "Вертикали",
      pools: "Пулы",
      funds: "Фонды",
      ledger: "Реестр",
      reputation: "Докажи доверие",
      marketplace: "Открой рынок",
      listings: "Листинги",
      orders: "Заявки",
      access: "Доступ",
      flows: "Сценарии",
      ...
      system: "Система",
      search: "Поиск",
      workflows: "Купи результат",
      pricing: "Прозрачные цены",
      developers: "Разработчикам",
      webhooks: "Вебхуки",
      billing: "Биллинг",
      credits: "Кредиты",
      feed: "Почувствуй пульс",
      analytics: "Аналитика",
      organizations: "Организации",
      builder: "Конструктор",
      whitepaper: "Прочитай тезис",
      acpPaper: "Рельс ACP",
      legal: "Доверие и условия",
      ...
      flora: "Любой цветок",
      tech: "Создай tech",
      startups: "Финансируй стартапы",
      insurance: "Закрой риск",
      arena: "Побеждай",
      ...
      explore: "Ещё больше",
      groupSpotlight: "Начни здесь",
      groupDesks: "Платные столы",
      groupWorlds: "Миры и рынки",
      groupBuild: "Строй и зарабатывай",
      groupSystem: "Операции и proof",
      ...
      salivaRx: "Saliva Rx",
      quantumSim: "Quantum SIM",
      literary: "Владей историей",
      nexus: "Войди в Nexus",
      entertainment: "Почувствуй шоу",
      mail: "Подключи почту",
    ...
    homePage: {
      ...
      wacpAddMetaMask: "Добавь wACP в MetaMask",
      ...
      mcpOpenApiLink: "OpenAPI / Swagger-документация",
      ...
      ctaSnapshot: "Сними токен — бесплатно",
      ctaSnapshotEyebrow: "Старт бесплатно",
      ctaProReportEyebrow: "Глубже",
      ctaProReport: "Возьми Pro-отчёт",
      ctaPayLink: "Создай ссылку на оплату",
    ...
    nexusPage: nexusPageByLang.ru,
    quantumSimPage: quantumSimPageByLang.ru,
    salivaRxPage: salivaRxPageByLang.ru,
    techPage: techByLang.ru,
    billingPage: billingByLang.ru,
    creditsPage: creditsByLang.ru,
    workflowsPage: workflowsByLang.ru,
    developersPage: developersByLang.ru,
    whitepaperPage: whitepaperByLang.ru,
    acpWhitepaperPage: acpWhitepaperByLang.ru,
    bridgePage: bridgeByLang.ru,
    referralsPage: referralsByLang.ru,
    proofCenterPage: proofCenterByLang.ru,
    searchPage: searchByLang.ru,
    ...
    governancePage: governancePageByLang.ru,
  ...
  uk: {
    nav: {
      product: "Увійди зараз",
      vision: "Побач шлях",
      docs: "Документація",
      contact: "Контакти",
      dashboard: "Твій пульт",
      agents: "Твої агенти",
      strategies: "Твоя перевага",
      verticals: "Вертикалі",
      pools: "Пули",
      funds: "Фонди",
      ledger: "Реєстр",
      reputation: "Доведи довіру",
      marketplace: "Відкрий ринок",
      listings: "Лістинги",
      orders: "Заявки",
      access: "Доступ",
      flows: "Сценарії",
      ...
      builder: "Конструктор",
      whitepaper: "Прочитай тезу",
      acpPaper: "Рейка ACP",
      legal: "Довіра і умови",
      aiConsole: "AI-консоль",
      referrals: "Реферали",
      evolution: "Еволюція",
      tournaments: "Турніри",
      ...
      tech: "Створи tech",
      startups: "Фінансуй стартапи",
      insurance: "Закрий ризик",
      arena: "Перемагай",
      ...
      explore: "Ще більше",
      groupSpotlight: "Почни тут",
      groupDesks: "Платні столи",
      groupWorlds: "Світи й ринки",
      groupBuild: "Будуй і заробляй",
      groupSystem: "Операції і proof",
      ...
      salivaRx: "Saliva Rx",
      quantumSim: "Quantum SIM",
      literary: "Володій історією",
      nexus: "Увійди в Nexus",
      entertainment: "Відчуй шоу",
      mail: "Підключи пошту",
      passport: "Твій паспорт"
    },
    hero: {
    ...
    homePage: {
      ...
      welcomeGrantLead: "Новий акаунт отримує грант доступу 100 ACP (номінальна мітка $100 — не виплата USD і не податкове відрахування).",
      ...
      wacpAddMetaMask: "Додай wACP у MetaMask",
      ...
      mcpOpenApiLink: "OpenAPI / Swagger-документація",
      mcpWorkflowsLink: "Каталог workflow",
      ...
      ctaSnapshot: "Зніми токен — безкоштовно",
      ctaSnapshotEyebrow: "Старт безкоштовно",
      ctaProReportEyebrow: "Глибше",
      ctaProReport: "Візьми Pro-звіт",
      ctaPayLink: "Створи посилання на оплату",
    ...
    auth: {
      ...
      welcomeGrantNote: "Новий акаунт отримує 100 ACP (мітка $100). Не виплата USD, не пожертва.",
      walletOr: "або",
    ...
    nexusPage: nexusPageByLang.uk,
    quantumSimPage: quantumSimPageByLang.uk,
    salivaRxPage: salivaRxPageByLang.uk,
    techPage: techByLang.uk,
    billingPage: billingByLang.uk,
    creditsPage: creditsByLang.uk,
    workflowsPage: workflowsByLang.uk,
    developersPage: developersByLang.uk,
    whitepaperPage: whitepaperByLang.uk,
    acpWhitepaperPage: acpWhitepaperByLang.uk,
    bridgePage: bridgeByLang.uk,
    referralsPage: referralsByLang.uk,
    proofCenterPage: proofCenterByLang.uk,
    searchPage: searchByLang.uk,
    ...
    governancePage: governancePageByLang.uk,
  ...
  de: {
    nav: {
      product: "Jetzt eintreten",
      vision: "Pfad sehen",
      docs: "Dokumentation",
      contact: "Kontakt",
      dashboard: "Dein Cockpit",
      agents: "Deine Agents",
      strategies: "Dein Edge",
      verticals: "Vertikalen",
      pools: "Kapitalpools",
      funds: "Fonds",
      ledger: "Hauptbuch",
      reputation: "Vertrauen beweisen",
      marketplace: "Markt öffnen",
      listings: "Angebote",
      orders: "Aufträge",
      access: "Zugang",
      flows: "Abläufe",
      ...
      system: "Systemstatus",
      search: "Suche",
      workflows: "Ergebnis kaufen",
      pricing: "Klare Preise",
      developers: "Entwickler",
      webhooks: "Webhooks-Ereignisse",
      billing: "Abrechnung",
      credits: "Guthaben",
      feed: "Puls spüren",
      analytics: "Analytik",
      ...
      builder: "Editor",
      whitepaper: "These lesen",
      acpPaper: "ACP-Schiene",
      legal: "Vertrauen & AGB",
      ...
      growth: "Schneller wachsen",
      staking: "Staking-Einsatz",
      runs: "Läufe",
      contracts: "Verträge",
      aeterna: "AETERNA",
      ...
      flora: "Jede Blume",
      tech: "Tech bauen",
      startups: "Startups finanzieren",
      insurance: "Risiko decken",
      arena: "Hier gewinnen",
      ...
      groupSpotlight: "Hier starten",
      groupDesks: "Bezahlte Desks",
      groupWorlds: "Welten & Märkte",
      groupBuild: "Bauen & verdienen",
      groupSystem: "Ops & Proof",
      ...
      salivaRx: "Saliva Rx",
      quantumSim: "Quantum SIM",
      literary: "Geschichte besitzen",
      nexus: "Nexus betreten",
      entertainment: "Show spüren",
      mail: "Mail verbinden",
      passport: "Dein Pass"
    },
    hero: {
    ...
    homePage: {
      ...
      welcomeGrantLead: "Neue Konten erhalten 100 ACP Zugangsguthaben (nominelles $100-Label — keine USD-Auszahlung, kein Steuerabzug).",
      ...
      wacpAddMetaMask: "wACP in MetaMask legen",
      ...
      mcpApiKeysLink: "API-Keys",
      mcpOpenApiLink: "OpenAPI-/Swagger-Dokumentation",
      ...
      ctaSnapshot: "Token-Snapshot — gratis",
      ctaSnapshotEyebrow: "Gratis starten",
      ctaProReportEyebrow: "Tiefer gehen",
      ctaProReport: "Pro-Risikobericht holen",
      ctaPayLink: "Deinen Pay-Link erstellen",
    ...
    auth: {
      ...
      welcomeGrantNote: "Neue Konten erhalten 100 ACP (Label $100). Keine USD-Auszahlung, keine Spende.",
      walletOr: "oder",
    ...
    nexusPage: nexusPageByLang.de,
    quantumSimPage: quantumSimPageByLang.de,
    salivaRxPage: salivaRxPageByLang.de,
    techPage: techByLang.de,
    billingPage: billingByLang.de,
    creditsPage: creditsByLang.de,
    workflowsPage: workflowsByLang.de,
    developersPage: developersByLang.de,
    whitepaperPage: whitepaperByLang.de,
    acpWhitepaperPage: acpWhitepaperByLang.de,
    bridgePage: bridgeByLang.de,
    referralsPage: referralsByLang.de,
    proofCenterPage: proofCenterByLang.de,
    searchPage: searchByLang.de,
    ...
    governancePage: governancePageByLang.de,
  ...
  "zh-Hant": {
    ...
    homePage: {
      ...
      welcomeGrantLead: "新帳戶獲得 100 ACP 使用額度（名義 $100 標示 — 非美元現金、不可抵稅）。",
      buyWorkflow: "購買工作流程",
      viewPricing: "查看定價",
      agentApi: "代理人 API",
      proofCenter: "證明中心",
      ...
      wacpAddMetaMask: "把 wACP 放進 MetaMask",
      creatorKicker: "創作並獲益",
      ...
      mcpOpenApiLink: "OpenAPI / Swagger 文件",
      ...
      galaxyCta: "開啟銀河拍賣",
      routeGalaxy: "銀河拍賣",
      ctaSnapshot: "免費掃描你的代幣",
      ctaSnapshotEyebrow: "免費開始",
      ctaProReportEyebrow: "深入一層",
      ctaProReport: "拿下 Pro 風險報告",
      ctaPayLink: "建立你的付款連結",
      ctaApi: "解鎖 ANCAP API",
      swaggerApi: "Swagger API",
    ...
    auth: {
      ...
      noAccount: "還沒有帳號？",
      haveAccount: "已經有帳號？",
      welcomeGrantNote: "新帳戶獲得 100 ACP（標示 $100）。非美元現金、非捐款。",
      walletOr: "或",
      connectWallet: "連接錢包",
    ...
    nexusPage: nexusPageByLang["zh-Hant"],
    quantumSimPage: quantumSimPageByLang["zh-Hant"],
    salivaRxPage: salivaRxPageByLang["zh-Hant"],
    techPage: techByLang["zh-Hant"],
    billingPage: billingByLang["zh-Hant"],
    creditsPage: creditsByLang["zh-Hant"],
    workflowsPage: workflowsByLang["zh-Hant"],
    developersPage: developersByLang["zh-Hant"],
    whitepaperPage: whitepaperByLang["zh-Hant"],
    acpWhitepaperPage: acpWhitepaperByLang["zh-Hant"],
    bridgePage: bridgeByLang["zh-Hant"],
    referralsPage: referralsByLang["zh-Hant"],
    proofCenterPage: proofCenterByLang["zh-Hant"],
    searchPage: searchByLang["zh-Hant"],
    ...
    governancePage: governancePageByLang["zh-Hant"],
