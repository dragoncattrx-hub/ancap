...
export const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    homePage: {
      ...
      galaxyLead: "Watch the local galaxy scale down to Sol, then bid ACP for stars, planets, and satellites on the ANCAP title auction.",
    ...
    galaxy: {
      ...
      lead: "Animated zoom from our galaxy to the Solar System, then live ACP lots for stars, planets, and satellites.",
      stars: "Stars",
      planets: "Planets",
  ...
  ru: {
    ...
    homePage: {
      ...
      galaxyLead: "Масштаб от нашей галактики до Солнца — затем ставки в ACP за звёзды, планеты и спутники на аукционе титулов ANCAP.",
    ...
    galaxy: {
      ...
      lead: "Анимация масштаба от нашей галактики до Солнечной системы и лоты ACP на звёзды, планеты и спутники.",
      stars: "Звёзды",
      planets: "Планеты",
      satellites: "Спутники",
      allLots: "Все лоты",
  ...
  uk: {
    ...
    homePage: {
      ...
      galaxyLead: "Масштаб від нашої галактики до Сонця — далі ставки в ACP за зірки, планети й супутники на аукціоні титулів ANCAP.",
    ...
    galaxy: {
      ...
      lead: "Анімація масштабу від нашої галактики до Сонячної системи та лоти ACP на зірки, планети й супутники.",
      stars: "Зірки",
      planets: "Планети",
  ...
  de: {
    ...
    homePage: {
      ...
      galaxyLead: "Skaliere von unserer Galaxie bis zur Sonne und biete ACP auf Sterne, Planeten und Satelliten in der ANCAP-Titelauktion.",
    ...
    galaxy: {
      ...
      lead: "Animierter Zoom von unserer Galaxie zum Sonnensystem, dann ACP-Lose für Sterne, Planeten und Satelliten.",
      stars: "Sterne",
      planets: "Planeten",
  ...
  "zh-Hant": {
    ...
    homePage: {
      ...
      galaxyLead: "從本銀河縮放到太陽，再以 ACP 競標恆星、行星與衛星的 ANCAP 權屬拍賣。",
      galaxyCta: "開啟銀河拍賣",
      routeGalaxy: "銀河拍賣",
    ...
    galaxy: {
      kicker: "銀河 → 太陽",
      title: "銀河拍賣",
      lead: "從本銀河縮放到太陽系的動畫，以及恆星、行星與衛星的 ACP 拍賣標的。",
      stars: "恆星",
      planets: "行星",
      satellites: "衛星",
      allLots: "全部標的",
