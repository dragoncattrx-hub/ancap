...
export const legalByLang: Record<Language, Tree> = {
  en: {
    ...
    hubCardMarketData: "How ANCAP uses CoinGecko and other third-party price feeds — indicative only.",
    ...
    r7Title: "7. Third-party market data",
    r7Body: "Spot prices, charts, or FX context shown on ANCAP may come from third-party providers such as CoinGecko. Those figures are indicative only: they are not a settlement price, oracle guarantee, offer to buy or sell, or investment advice. Desk quotes, bridge conversions, and ACP accounting units can differ from external market screens.",
    riskMarketDataMore: "Full market-data disclosure:",
    p9Title: "9. Third-party market-data providers",
    p9Body: "To show indicative crypto and FX context, ANCAP may call third-party market-data APIs (currently CoinGecko). Those requests use ANCAP server credentials and typically do not send your account password. Provider logs may include technical metadata under their own privacy terms. We do not sell your personal data to market-data vendors.",
    marketDataKicker: "Client disclosure",
    marketDataTitle: "Market data and CoinGecko",
    marketDataIntro: "This notice explains how ANCAP uses third-party market-data providers on ancap.cloud. It complements the Risk Disclosure and Privacy Notice.",
    md1Title: "1. What we show",
    ...
    md3Title: "3. Accuracy and availability",
    ...
    md5Title: "5. Your responsibility",
    ...
    marketDataAttributionTitle: "Provider",
    marketDataAttributionBody: "Market data provided by CoinGecko. Review CoinGecko's own terms and privacy policy on their website.",
  ...
  ru: {
    ...
    hubCardMarketData: "Как ANCAP использует CoinGecko и другие ценовые ленты — только ориентировочно.",
    ...
    r7Title: "7. Сторонние рыночные данные",
    r7Body: "Спотовые цены, графики или FX-контекст на ANCAP могут поступать от сторонних провайдеров, в том числе CoinGecko. Это только ориентиры: не цена расчёта, не оракул-гарантия, не оферта купли/продажи и не инвестиционный совет. Котировки desk, конверсии моста и учётные единицы ACP могут отличаться от внешних экранов.",
    riskMarketDataMore: "Полное раскрытие по рыночным данным:",
    p9Title: "9. Провайдеры рыночных данных",
    p9Body: "Чтобы показывать ориентировочный крипто- и FX-контекст, ANCAP может вызывать сторонние API (сейчас CoinGecko). Запросы идут с серверными ключами ANCAP и обычно не передают ваш пароль. У провайдера могут оставаться технические логи по их политике. Мы не продаём ваши персональные данные вендорам рыночных данных.",
    marketDataKicker: "Раскрытие для клиентов",
    marketDataTitle: "Рыночные данные и CoinGecko",
    marketDataIntro: "Как ANCAP использует сторонние рыночные данные на ancap.cloud. Дополняет раскрытие рисков и уведомление о конфиденциальности.",
    md1Title: "1. Что мы показываем",
    ...
    md3Title: "3. Точность и доступность",
    ...
    md5Title: "5. Ваша ответственность",
    ...
    marketDataAttributionTitle: "Провайдер",
    marketDataAttributionBody: "Рыночные данные предоставлены CoinGecko. Ознакомьтесь с условиями и политикой конфиденциальности CoinGecko на их сайте.",
  ...
  uk: {
    ...
    marketDataAttributionTitle: "Провайдер",
    marketDataAttributionBody: "Ринкові дані надано CoinGecko.",
  ...
  de: {
    ...
    marketDataAttributionBody: "Marktdaten von CoinGecko.",
  ...
  "zh-Hant": {
    ...
    marketDataAttributionBody: "市場數據由 CoinGecko 提供。",
    refundsKicker: "帳單政策",
    refundsTitle: "付款與退款",
