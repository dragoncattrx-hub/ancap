...
export const legalByLang: Record<Language, Tree> = {
  en: {
    ...
    substanceCodingLink: "Substance coding",
    hubCardSubstanceCoding: "Licensed addiction-medicine partner brief — light, clinic substances, hypnosis. Not a coding session by ANCAP.",
    substanceCodingKicker: "Legal / narcology / substance coding literacy",
    substanceCodingTitle: "Substance coding — licensed clinician partner rail",
    substanceCodingIntro: "15 September 2026. ANCAP settles ACP for a licensed addiction-medicine / clinical-hypnosis partner handoff. Not a coding session by ANCAP.",
    sc1Title: "1. Platform role",
    sc1Body: "ANCAP is a commercial ACP platform. It settles payment and issues a partner handoff brief. ANCAP is not a narcology clinic and does not perform coding.",
    sc2Title: "2. Modalities literacy only",
    sc2Body: "Light protocols, clinic-only substance protocols, and clinical hypnosis are literacy themes for the licensed partner — not services delivered by ANCAP staff.",
    sc3Title: "3. Non-essential substances",
    sc3Body: "The rail targets psychoactive dependence on substances that are not necessary for life. It is not emergency detox sold by ANCAP.",
    sc4Title: "4. No abstinence guarantee",
    sc4Body: "Paying ACP does not guarantee sobriety, coding success, or any clinical outcome.",
    sc5Title: "5. No controlled-substance sale by ANCAP",
    sc5Body: "ANCAP does not compound, prescribe, or sell controlled substances. Clinic medications stay with the licensed partner.",
    sc6Title: "6. Hypnosis is clinical, not entertainment",
    sc6Body: "Hypnosis literacy refers to licensed clinical practice after screening — not stage hypnosis.",
    sc7Title: "7. Emergency care",
    sc7Body: "Overdose, withdrawal crises, and psychiatric emergencies require local emergency services — not this desk.",
    sc8Title: "8. Data",
    sc8Body: "Do not upload sensitive health data without lawful basis and consent.",
    sc9Title: "9. Payments",
    sc9Body: "48,000 ACP covers the desk brief and handoff. Ongoing clinical fees are billed by the licensed partner.",
    sc10Title: "10. Contact",
    sc10Body: "Questions: legal@ancap.cloud. Product: /aeterna#substance-coding.",
    footerSubstanceCoding: "Substance coding",
    teslaCoilPartyLink: "Tesla coil party",
    hubCardTeslaCoilParty: "Licensed venue Tesla-coil party brief with Jack Daniel's hospitality literacy and jurisdiction-permitted adult substances only. Age-gated.",
    teslaCoilPartyKicker: "Legal / entertainment / Tesla coil party",
    teslaCoilPartyTitle: "Tesla coil party — licensed venue partner rail",
    teslaCoilPartyIntro: "15 September 2026. ANCAP settles ACP for a licensed entertainment-venue partner handoff. Not affiliated with Jack Daniel's.",
    tcp1Title: "1. Platform role",
    tcp1Body: "ANCAP sells an ACP-settled venue partner brief. ANCAP is not a nightclub, bar, or liquor licensee.",
    tcp2Title: "2. Jack Daniel's trademark",
    tcp2Body: "Jack Daniel's is a trademark of Brown-Forman. ANCAP is not affiliated with, endorsed by, or sponsored by Jack Daniel's or Brown-Forman.",
    tcp3Title: "3. Complimentary whiskey literacy",
    tcp3Body: "Free whiskey hospitality is venue-partner literacy where the venue holds a liquor licence. ANCAP does not pour or sell alcohol.",
    tcp4Title: "4. Age / ID gates",
    tcp4Body: "Events are age-gated (18+ or 21+ by jurisdiction). ID checks are the venue partner's duty.",
    tcp5Title: "5. Permitted substances only",
    tcp5Body: "Jurisdiction-permitted adult substances means only substances lawful for adults at the event locale under venue rules. ANCAP does not sell cannabis or controlled substances.",
    tcp6Title: "6. Tesla coil HV safety",
    tcp6Body: "High-voltage Tesla coil operation is licensed venue electrical-safety literacy only — not a DIY coil kit sold by ANCAP.",
    tcp7Title: "7. No show outcome guarantee",
    tcp7Body: "ANCAP does not guarantee sparks, attendance, weather, or hospitality inventory.",
    tcp8Title: "8. Local law",
    tcp8Body: "Alcohol, cannabis, and public-event rules vary by country and city. The venue partner must comply locally.",
    tcp9Title: "9. Payments",
    tcp9Body: "8,900 ACP covers the desk brief and handoff. Ticket upgrades and bar tabs are billed by the venue.",
    tcp10Title: "10. Contact",
  ...
  ru: {
    ...
    substanceCodingLink: "Кодирование от веществ",
    hubCardSubstanceCoding: "Бриф для лицензированного нарколога — свет, вещества клиники, гипноз. Не сеанс кодирования от ANCAP.",
    substanceCodingKicker: "Право / наркология / грамотность кодирования",
    substanceCodingTitle: "Кодирование от веществ — рельс лицензированного клинициста",
    substanceCodingIntro: "15 сентября 2026. ANCAP принимает ACP за handoff к лицензированному партнёру. Не сеанс кодирования от ANCAP.",
    sc1Title: "1. Роль платформы",
    sc1Body: "ANCAP — коммерческая ACP-платформа. Не наркологическая клиника и не проводит кодирование.",
    sc2Title: "2. Только грамотность модальностей",
    sc2Body: "Свет, клиника-only вещества и клинический гипноз — темы для лицензированного партнёра.",
    sc3Title: "3. Не необходимые для жизни вещества",
    sc3Body: "Рельс про психоактивную зависимость от веществ, не нужных для жизни.",
    sc4Title: "4. Без гарантии трезвости",
    sc4Body: "Оплата ACP не гарантирует трезвость или успех кодирования.",
    sc5Title: "5. Без продажи контролируемых веществ",
    sc5Body: "ANCAP не компаундит и не продаёт контролируемые вещества.",
    sc6Title: "6. Гипноз клинический",
    sc6Body: "Не сценический гипноз — только лицензированная клиника после скрининга.",
    sc7Title: "7. Экстренная помощь",
    sc7Body: "Передозировка и абстиненция — к местной скорой, не к этому столу.",
    sc8Title: "8. Данные",
    sc8Body: "Не загружайте медданные без правового основания и согласия.",
    sc9Title: "9. Оплата",
    sc9Body: "48 000 ACP — бриф и handoff. Дальнейшие счета — у партнёра.",
    sc10Title: "10. Контакт",
    sc10Body: "legal@ancap.cloud · /aeterna#substance-coding",
    footerSubstanceCoding: "Кодирование от веществ",
    teslaCoilPartyLink: "Пати с катушкой Теслы",
    hubCardTeslaCoilParty: "Бриф лицензированной площадки: катушка Теслы, hospitality Jack Daniel's, только разрешённые вещества. Возрастной контроль.",
    teslaCoilPartyKicker: "Право / развлечения / пати с катушкой Теслы",
    teslaCoilPartyTitle: "Пати с катушкой Теслы — рельс лицензированной площадки",
    teslaCoilPartyIntro: "15 сентября 2026. ANCAP принимает ACP за handoff к лицензированной площадке. Не аффилирован с Jack Daniel's.",
    tcp1Title: "1. Роль платформы",
    tcp1Body: "ANCAP продаёт ACP-бриф площадки. Не бар и не держатель алкогольной лицензии.",
    tcp2Title: "2. Товарный знак Jack Daniel's",
    tcp2Body: "Jack Daniel's — знак Brown-Forman. ANCAP не аффилирован и не спонсируется ими.",
    tcp3Title: "3. Бесплатный виски — грамотность hospitality",
    tcp3Body: "Complimentary whiskey — у лицензированной площадки. ANCAP алкоголь не наливает.",
    tcp4Title: "4. Возраст / ID",
    tcp4Body: "18+ или 21+ по юрисдикции. Проверка документов — обязанность площадки.",
    tcp5Title: "5. Только разрешённые вещества",
    tcp5Body: "Только lawful adult substances на площадке. ANCAP не продаёт каннабис и контролируемые вещества.",
    tcp6Title: "6. HV-безопасность катушки",
    tcp6Body: "Катушка Теслы — только у лицензированного оператора площадки, не DIY-набор от ANCAP.",
    tcp7Title: "7. Без гарантии шоу",
    tcp7Body: "Нет гарантии искр, посещаемости или запасов бара.",
    tcp8Title: "8. Местное право",
    tcp8Body: "Правила алкоголя и мероприятий различаются по странам — соблюдает площадка.",
    tcp9Title: "9. Оплата",
    tcp9Body: "8900 ACP — бриф и handoff. Билеты и бар — у площадки.",
    tcp10Title: "10. Контакт",
  ...
  uk: {
    ...
    substanceCodingLink: "Кодування від речовин",
    hubCardSubstanceCoding: "Бріф для ліцензованого нарколога — світло, речовини клініки, гіпноз. Не сеанс кодування від ANCAP.",
    substanceCodingKicker: "Право / наркологія / грамотність кодування",
    substanceCodingTitle: "Кодування від речовин — рейка ліцензованого клініциста",
    substanceCodingIntro: "15 вересня 2026. ANCAP приймає ACP за handoff до ліцензованого партнера. Не сеанс кодування від ANCAP.",
    sc1Title: "1. Роль платформи",
    sc1Body: "ANCAP — комерційна ACP-платформа. Не наркологічна клініка і не проводить кодування.",
    sc2Title: "2. Лише грамотність модальностей",
    sc2Body: "Світло, clinic-only речовини та клінічний гіпноз — теми для ліцензованого партнера.",
    sc3Title: "3. Не життєво необхідні речовини",
    sc3Body: "Рейка про психоактивну залежність від речовин, не потрібних для життя.",
    sc4Title: "4. Без гарантії тверезості",
    sc4Body: "Оплата ACP не гарантує тверезість чи успіх кодування.",
    sc5Title: "5. Без продажу контрольованих речовин",
    sc5Body: "ANCAP не компаундить і не продає контрольовані речовини.",
    sc6Title: "6. Гіпноз клінічний",
    sc6Body: "Не сценічний гіпноз — лише ліцензована клініка після скринінгу.",
    sc7Title: "7. Невідкладна допомога",
    sc7Body: "Передозування та абстиненція — до місцевої швидкої, не до цього столу.",
    sc8Title: "8. Дані",
    sc8Body: "Не завантажуйте меддані без законної підстави та згоди.",
    sc9Title: "9. Оплата",
    sc9Body: "48 000 ACP — бріф і handoff. Подальші рахунки — у партнера.",
    sc10Title: "10. Контакт",
    sc10Body: "legal@ancap.cloud · /aeterna#substance-coding",
    footerSubstanceCoding: "Кодування від речовин",
    teslaCoilPartyLink: "Паті з котушкою Тесли",
    hubCardTeslaCoilParty: "Бріф ліцензованого майданчика: котушка Тесли, hospitality Jack Daniel's, лише дозволені речовини. Віковий контроль.",
    teslaCoilPartyKicker: "Право / розваги / паті з котушкою Тесли",
    teslaCoilPartyTitle: "Паті з котушкою Тесли — рейка ліцензованого майданчика",
    teslaCoilPartyIntro: "15 вересня 2026. ANCAP приймає ACP за handoff до ліцензованого майданчика. Не афілійовано з Jack Daniel's.",
    tcp1Title: "1. Роль платформи",
    tcp1Body: "ANCAP продає ACP-бріф майданчика. Не бар і не держатель алкогольної ліцензії.",
    tcp2Title: "2. Товарний знак Jack Daniel's",
    tcp2Body: "Jack Daniel's — знак Brown-Forman. ANCAP не афілійований і не спонсорується ними.",
    tcp3Title: "3. Безкоштовний віскі — грамотність hospitality",
    tcp3Body: "Complimentary whiskey — у ліцензованого майданчика. ANCAP алкоголь не наливає.",
    tcp4Title: "4. Вік / ID",
    tcp4Body: "18+ або 21+ за юрисдикцією. Перевірка документів — обов'язок майданчика.",
    tcp5Title: "5. Лише дозволені речовини",
    tcp5Body: "Лише lawful adult substances на майданчику. ANCAP не продає канабіс і контрольовані речовини.",
    tcp6Title: "6. HV-безпека котушки",
    tcp6Body: "Котушка Тесли — лише у ліцензованого оператора майданчика, не DIY-набір від ANCAP.",
    tcp7Title: "7. Без гарантії шоу",
    tcp7Body: "Немає гарантії іскор, відвідуваності чи запасів бару.",
    tcp8Title: "8. Місцеве право",
    tcp8Body: "Правила алкоголю та заходів різняться за країнами — дотримується майданчик.",
    tcp9Title: "9. Оплата",
    tcp9Body: "8900 ACP — бріф і handoff. Квитки та бар — у майданчика.",
    tcp10Title: "10. Контакт",
    tcp10Body: "legal@ancap.cloud · /entertainment#tesla-coil-party",
  ...
  de: {
    ...
    substanceCodingLink: "Substance Coding",
    hubCardSubstanceCoding: "Partnerbrief eines lizenzierten Klinikers zur Coding-Literacy — Licht, Klinik-Substanzen, Hypnose. Keine Coding-Sitzung durch ANCAP.",
    substanceCodingKicker: "Legal / Narkologie / Substance-Coding-Literacy",
    substanceCodingTitle: "Substance Coding — Schiene des lizenzierten Klinikers",
    substanceCodingIntro: "15. September 2026. ANCAP nimmt ACP fuer einen lizenzierten Suchtmedizin- / Hypnose-Partner-Handoff entgegen. Keine Coding-Sitzung durch ANCAP.",
    sc1Title: "1. Plattformrolle",
    sc1Body: "ANCAP ist eine kommerzielle ACP-Plattform. Keine Narkologie-Klinik und kein Coding durch ANCAP.",
    sc2Title: "2. Nur Modalitaets-Literacy",
    sc2Body: "Licht, klinik-only Substanzen und klinische Hypnose sind Themen fuer den lizenzierten Partner.",
    sc3Title: "3. Nicht lebensnotwendige Substanzen",
    sc3Body: "Die Schiene betrifft psychoaktive Abhaengigkeit von Substanzen, die nicht lebensnotwendig sind.",
    sc4Title: "4. Keine Abstinenzgarantie",
    sc4Body: "ACP-Zahlung garantiert keine Nuechternheit und keinen Coding-Erfolg.",
    sc5Title: "5. Kein Verkauf kontrollierter Substanzen",
    sc5Body: "ANCAP compoundiert und verkauft keine kontrollierten Substanzen.",
    sc6Title: "6. Hypnose ist klinisch",
    sc6Body: "Keine Buehnenhypnose — nur lizenzierte Klinik nach Screening.",
    sc7Title: "7. Notfallversorgung",
    sc7Body: "Ueberdosis und Entzug gehoeren zum lokalen Notdienst — nicht zu diesem Desk.",
    sc8Title: "8. Daten",
    sc8Body: "Keine Gesundheitsdaten ohne Rechtsgrundlage und Einwilligung hochladen.",
    sc9Title: "9. Zahlungen",
    sc9Body: "48.000 ACP decken Brief und Handoff. Weitere Gebuehren stellt der Partner.",
    sc10Title: "10. Kontakt",
    sc10Body: "Fragen: legal@ancap.cloud. Produkt: /aeterna#substance-coding.",
    footerSubstanceCoding: "Substance Coding",
    teslaCoilPartyLink: "Teslaspulen-Party",
    hubCardTeslaCoilParty: "Lizenzierter Venue-Brief: Teslaspule, Jack Daniel's Hospitality-Literacy, nur zulaessige Substanzen. Altersgeprueft.",
    teslaCoilPartyKicker: "Legal / Entertainment / Teslaspulen-Party",
    teslaCoilPartyTitle: "Teslaspulen-Party — Schiene des lizenzierten Venues",
    teslaCoilPartyIntro: "15. September 2026. ANCAP nimmt ACP fuer einen lizenzierten Venue-Handoff entgegen. Nicht affiliated mit Jack Daniel's.",
    tcp1Title: "1. Plattformrolle",
    tcp1Body: "ANCAP verkauft einen ACP-Venue-Brief. Keine Bar und keine Schanklizenz.",
    tcp2Title: "2. Marke Jack Daniel's",
    tcp2Body: "Jack Daniel's ist eine Marke von Brown-Forman. ANCAP ist nicht affiliated oder gesponsert.",
    tcp3Title: "3. Complimentary Whiskey — Hospitality-Literacy",
    tcp3Body: "Kostenloser Whiskey nur beim lizenzierten Venue. ANCAP schenkt keinen Alkohol aus.",
    tcp4Title: "4. Alter / ID",
    tcp4Body: "18+ oder 21+ je nach Jurisdiktion. Ausweiskontrolle ist Pflicht des Venues.",
    tcp5Title: "5. Nur zulaessige Substanzen",
    tcp5Body: "Nur fuer Erwachsene am Eventort zulaessige Substanzen. ANCAP verkauft kein Cannabis.",
    tcp6Title: "6. HV-Sicherheit der Spule",
    tcp6Body: "Teslaspule nur durch lizenzierten Venue-Operator — kein DIY-Kit von ANCAP.",
    tcp7Title: "7. Keine Show-Garantie",
    tcp7Body: "Keine Garantie fuer Funken, Auslastung oder Bar-Bestand.",
    tcp8Title: "8. Ortsrecht",
    tcp8Body: "Alkohol- und Eventregeln unterscheiden sich — das Venue muss lokal compliant sein.",
    tcp9Title: "9. Zahlungen",
    tcp9Body: "8.900 ACP decken Brief und Handoff. Tickets und Bar stellt das Venue.",
    tcp10Title: "10. Kontakt",
  ...
  "zh-Hant": {
    ...
    substanceCodingLink: "物質編碼",
    hubCardSubstanceCoding: "持照成癮醫學夥伴編碼素養簡報——光、診所物質、催眠。非 ANCAP 編碼療程。",
    substanceCodingKicker: "法律／麻醉／物質編碼素養",
    substanceCodingTitle: "物質編碼——持照臨床醫師夥伴軌道",
    substanceCodingIntro: "2026 年 9 月 15 日。ANCAP 以 ACP 結算向持照成癮醫學／臨床催眠夥伴交接。非 ANCAP 編碼療程。",
    sc1Title: "1. 平台角色",
    sc1Body: "ANCAP 為商業 ACP 平台。非麻醉診所，亦不執行編碼。",
    sc2Title: "2. 僅模態素養",
    sc2Body: "光、診所限定物質與臨床催眠為持照夥伴主題——非 ANCAP 員工服務。",
    sc3Title: "3. 非生命必需物質",
    sc3Body: "本軌道針對非生命必需精神活性物質依賴。非 ANCAP 急診戒毒。",
    sc4Title: "4. 無戒斷保證",
    sc4Body: "支付 ACP 不保證清醒或編碼成功。",
    sc5Title: "5. ANCAP 不販售管制物質",
    sc5Body: "ANCAP 不複配、不開方、不販售管制物質。診所用藥留在持照夥伴。",
    sc6Title: "6. 催眠為臨床而非娛樂",
    sc6Body: "催眠素養指篩檢後之持照臨床實務——非舞台催眠。",
    sc7Title: "7. 急診照護",
    sc7Body: "過量、戒斷危象與精神急症須求助當地急診——非本服務台。",
    sc8Title: "8. 資料",
    sc8Body: "無合法依據與同意時請勿上傳敏感健康資料。",
    sc9Title: "9. 付款",
    sc9Body: "48,000 ACP 涵蓋簡報與交接。後續臨床費用由夥伴收取。",
    sc10Title: "10. 聯絡",
    sc10Body: "問題：legal@ancap.cloud。產品：/aeterna#substance-coding。",
    footerSubstanceCoding: "物質編碼",
    teslaCoilPartyLink: "特斯拉線圈派對",
    hubCardTeslaCoilParty: "持照場館特斯拉線圈派對簡報：Jack Daniel's 招待素養與僅管轄區允許之成人物質。年齡門檻。",
    teslaCoilPartyKicker: "法律／娛樂／特斯拉線圈派對",
    teslaCoilPartyTitle: "特斯拉線圈派對——持照場館夥伴軌道",
    teslaCoilPartyIntro: "2026 年 9 月 15 日。ANCAP 以 ACP 結算向持照娛樂場館交接。與 Jack Daniel's 無關。",
    tcp1Title: "1. 平台角色",
    tcp1Body: "ANCAP 販售 ACP 場館夥伴簡報。非夜店、酒吧或酒牌持有人。",
    tcp2Title: "2. Jack Daniel's 商標",
    tcp2Body: "Jack Daniel's 為 Brown-Forman 商標。ANCAP 與之無關、未獲代言或贊助。",
    tcp3Title: "3. 免費威士忌招待素養",
    tcp3Body: "免費威士忌為持照場館之招待素養。ANCAP 不倒酒、不販售酒精。",
    tcp4Title: "4. 年齡／身分門檻",
    tcp4Body: "依管轄區適用 18+ 或 21+。身分查核為場館職責。",
    tcp5Title: "5. 僅允許之物質",
    tcp5Body: "僅活動地點對成人合法之物質。ANCAP 不販售大麻或管制物質。",
    tcp6Title: "6. 特斯拉線圈高壓安全",
    tcp6Body: "高壓線圈僅由持照場館電氣安全素養操作——非 ANCAP DIY 套件。",
    tcp7Title: "7. 無表演結果保證",
    tcp7Body: "ANCAP 不保證火花、出席、天候或招待庫存。",
    tcp8Title: "8. 當地法律",
    tcp8Body: "酒精、大麻與公開活動規則因地而異。場館須遵守當地法。",
    tcp9Title: "9. 付款",
    tcp9Body: "8,900 ACP 涵蓋簡報與交接。門票升級與酒吧帳單由場館收取。",
    tcp10Title: "10. 聯絡",
