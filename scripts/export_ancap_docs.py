...
def _manifest_text(exported_paths: list[Path]) -> str:
    lines = [
        ...
        "It intentionally includes only public-safe documentation, governance files, contributor issue/PR templates, the first-push labels / Discussions bootstrap checklist, the label seed for the future docs repo, the initial Discussions category seed, and a baseline CODEOWNERS file for review routing.",
