...
Status: [~] Repo-side hardening is in place and test-covered, `docs/PRODUCTION_SECRET_BASELINE.md` now captures the operator provisioning/evidence checklist, and production deployment still needs real secrets supplied in env/CI.
